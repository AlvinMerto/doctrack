...
<div id="division_select" class='mb-3'>
    <p> Division </p>
    <select name="divisionselect" id="divisionselect" class=" block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm/6">
...
<div id="office_select" class='mb-3'>
    <p> Office </p>
    <select name="officeselect" id="officeselect" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm/6">
        <option value='0'> -- Select </option>
...
<div id="role_select" class='mb-3'>
    <p> Assigned Role </p>
    <select name="assignedrole" id="assignedrole" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm/6">
