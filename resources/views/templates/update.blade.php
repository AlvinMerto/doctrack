...
<table id="u_content_heading_1" style="font-family:'Raleway',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  <tbody>
    <tr>
      <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:51px 10px 30px 20px;font-family:'Raleway',sans-serif;" align="left">
...
<table id="u_content_heading_2" style="font-family:'Raleway',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  <tbody>
    <tr>
      <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:20px 10px 27px 43px;font-family:'Raleway',sans-serif;" align="left">
...
<p style="line-height: 160%; margin: 40px 0px 0px 0px;">Dear <?php echo $data['name']; ?>,</p><p style="line-height: 160%; margin: 0px;"></p>
<p style="line-height: 160%; margin: 0px;">A document named <strong>[ <?php echo $data['title']; ?> ]</strong> has an update for you. </p>
<p style="line-height: 160%; margin: 0px;"></p>
<p style="line-height: 160%; margin: 0px;">With the following details:</p>
<ol>
<li style="line-height: 22.4px;">Document Name: <strong> <?php echo $data['title']; ?> </strong> </li>
<li style="line-height: 22.4px;">Barcode Number: <strong> <?php echo $data['bid']; ?> </strong> </li>
<li style="line-height: 22.4px;">Update: <strong> <?php echo $data['update']; ?> </strong> </li>
</ol>
<p style="line-height: 160%; margin: 0px;">To view the document please visit the link below</p>
  </div>
...
<a href="<?php echo $data['url']; ?>" target="_blank" class="v-button v-size-width v-font-size" style="box-sizing: border-box; display: inline-block; text-decoration: none; text-size-adjust: none; text-align: center; color: rgb(255, 255, 255); background: rgb(17, 124, 93); border-radius: 4px; width: 53%; max-width: 100%; word-break: break-word; overflow-wrap: break-word; font-size: 14px; line-height: inherit;"><span style="display:block;padding:10px 20px;line-height:120%;">Document Tracking System</span>
    </a>
    <!--[if mso]></td></tr></table><![endif]-->
</div>
...
<table id="u_content_text_2" style="font-family:'Raleway',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div class="v-text-align v-font-size" style="font-size: 14px; line-height: 160%; text-align: left; word-wrap: break-word;">
<p style="line-height: 160%; margin: 0px;">This email confirms that you have received the document.</p>
  </div>
...
<table id="u_content_heading_4" style="font-family:'Raleway',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <!--[if mso]><table width="100%"><tr><td><![endif]-->
    <h1 class="v-text-align v-font-size" style="margin: 0px; color: #ffffff; line-height: 140%; text-align: left; word-wrap: break-word; font-size: 22px; font-weight: 400;"><span>Thanks for the support! 😍</span></h1>
  <!--[if mso]></td></tr></table><![endif]-->
...
<table id="u_content_text_3" style="font-family:'Raleway',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  <tbody>
   ...
   <br />Please reach out to us if you have any thoughts to <a href="mailto:alvinjay.merto@minda.gov.ph"> KMD-IT</a>. We’d love to hear from you!</span></p>
  </div>
...
<p style="line-height: 140%; margin: 0px;">PRIVACY POLICY | WEB</p>
  </div>
...
<table id="u_content_heading_6" style="font-family:'Raleway',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  <tbody>
    <tr>
      <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:16px 10px 10px;font-family:'Raleway',sans-serif;" align="left">
        
  <!--[if mso]><table width="100%"><tr><td><![endif]-->
    <h1 class="v-text-align v-font-size" style="margin: 0px; color: #ffffff; line-height: 140%; text-align: center; word-wrap: break-word; font-size: 22px; font-weight: 400;"><span><img alt="" src="{{ asset('minda_logo.png') }}"/></span></h1>
  <!--[if mso]></td></tr></table><![endif]-->
